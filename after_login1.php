  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="active" href="after_login1.php">Home</a></li>
          ...
          <li><a href="provide_mentorship.php">Mentorship</a></li>
            <li><a href="#">/</a></li>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 cta-btn-container text-center">
            <a class="cta-btn align-middle" href="campaign-list1.php">Invest Now</a>
          </div>
        </div>
      </div>
    </section>
