    ...
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="active" href="campaign-list1.php">Ideas</a></li>
...
<body>
  ...
  <h1><center>Ongoing Startup-Fundings</center></h1>
  <br>
  <br>
...
$sql = "SELECT name, founder, description, picture, city, goal, start_date FROM startups";
...
while ($row = mysqli_fetch_assoc($result)) {
  echo "<div class='card'>";
  echo "<img class='card-img-top' src='" . $row['picture'] . "' alt='Startup Logp'>";
  echo "<div class='card-body'>";
  echo "<h5 class='card-title'>" . $row['name'] . "</h5>";
  echo "<h3 class='card-text'>Founder: " . $row['founder'] . "</h3>";
  ...
  // echo "<a href='https://cosmofeed.com/vp/640223b4869328001f5d97a0' class='btn btn-primary'>Invest</a>";
  echo "</div>";
  echo "</div>";
}
echo "</div>";
