  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        ...
        <h2 class="text-light"><a href="index.php">InvestConnect</a></h2>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="campaign-list.php">Ideas</a></li>
  ...
  <main id="main">
    ...
    <hr>
     ...
     <section class="fundraiser-section">
            <h2>Our Platform</h2>
            <h5><center></center><i>InvestConnect is a great way to make connections. Whether it's for Raising or to make investments for growth. </i></center></h5>
            <h5><center><i></i>By participating in our platform, you not only support startups as investors, but you also get to know about new ideas. Whether it's through Founders or Connections.</i></center> </h5>
            <br>
