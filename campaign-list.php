    ...
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="active" href="campaign-list.php">Ideas</a></li>
...
while ($row = mysqli_fetch_assoc($result)) {
  echo "<div class='card'>";
  echo "<img class='card-img-top' src='" . $row['picture'] . "' alt='Startup Logo'>";
  echo "<div class='card-body'>";
  echo "<h5 class='card-title'>" . $row['name'] . "</h5>";
  echo "<h4 class='card-text'>Founder: " . $row['founder'] . "</h4>";
